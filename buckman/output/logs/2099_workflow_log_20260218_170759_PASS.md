...
| Field | Value |
|-------|-------|
| **Run Timestamp** | 2026-02-18 17:07:59 |
| **Processing Year** | 2099 |
| **Operator** | bradwolaver |
| **Machine** | OSE-HYDRO-D0P3 |
| **OS** | Linux 5.15.167.4-microsoft-standard-WSL2 |
| **Python** | 3.10.12 |
| **Git Commit** | 782b83a09f20 (clean) |
| **Branch** | master |

## 2. Executive Summary

- **Total Pumping:** 0.00 AF
- **Rio Grande Depletion (Below Otowi):** 0.00 AF
- **Rio Grande Depletion (Above Otowi):** 0.00 AF
...
- Input: `Buckman_Well_Prod_2099.csv`
...
- Output: `thruCY2165_2099.wel`, `CY2099.nam`

### Step 3: Run MODFLOW96
- Executable: modflow96.exe (via Wine)
- Output: `CY2099.lst`, flux files (.flx)
...
**Total Pumping: 0.00 AF** in calendar year 2099.
...
Depletions below Otowi Bridge (0.00 AF) are chargeable against
...
**2099 Impact:**
- Below Otowi depletion: 0.00 AF
- Above Otowi depletion: 0.00 AF (does not affect compact)
- This represents 0.0000% of typical annual NM allocation


### Tributary Stream Impacts (Table 3)

**Rio Pojoaque:**
- 2099 Depletion: 0.00 AF
- Residual Component: 0.00 AF (pre-1988 pumping tail)
- Superposition Component: 0.00 AF (1988-2099 pumping)
...
**2099 Status:**
- Cumulative impact since 2004: 0.00 AF
- Annual increment: 0.00 AF
